...

{
  ...
  {  # learning weights using ridge regression
    ...
    if (metalearner=="Ridge"){
      ...
      result <- list(weights =  weightsDF_ridge, metalearner = "Ridge", comb.method = "stack")
    ...
    # learning weights using lasso regression
      ...
      result <- list(weights =  weightsDF_lasso, metalearner = "Lasso", comb.method = "stack")
    ...
    # learning weights using elastic net regression
      ...
      result <- list(weights =  weightsDF_elastic, metalearner = "Elastic", comb.method = "stack")
    ...
    # learning weights using non-negative least square regression
      ...
      result <- list(weights = weightsDF_nnls, metalearner = "nnls",  comb.method = "stack")
    ...
    # learning weights using linear squared regression
      ...
      result <- list(weights = weightsDF_linear,  metalearner = "Linear", comb.method = "stack")
